...
igraph_vector_t boudingEccentricities(igraph_t graph) {
    ...
    while (n_verts > 0)
    {
        ...
        it++;
        std::cout << "iteration " << it << " - n_verts=" << n_verts << " - v=" << v << " \n";
        ...
        std::cout << "candidates : ";
        print_vector_bool(&candidates, n_verts_total);
        ...
        std::cout << "eccL : ";
        print_vector(&eccL, n_verts_total);
        std::cout << "eccU : ";
        print_vector(&eccU, n_verts_total);
        std::cout << "ecc : ";
